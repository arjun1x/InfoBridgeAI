// InfoBridge Landing Page Sign-Up JavaScript
    ...
    async function handleSignup(event) {
        ...
        try {
            ...
            if (response.ok && result.success) {
                // Success - store user info for personalized experience
                localStorage.setItem('infobridgeUser', JSON.stringify({
                ...
                showGlobalMessage(`🎉 Welcome to InfoBridge, ${userData.username}! Redirecting you to your AI assistant...`, true);
                
                // Reset form
                signupForm.reset();
                document.getElementById('passwordStrength').textContent = '';
                
                // Redirect to InfoBridge main page after 3 seconds
                setTimeout(() => {
                    window.location.href = 'InfoBridge.html?newUser=true&username=' + encodeURIComponent(userData.username);
                }, 3000);
            ...
            signupBtn.innerHTML = '<i class="fas fa-user-plus"></i> Create Account & Enter InfoBridge';
        }
    }
});
